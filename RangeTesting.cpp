...
void TestCase1()
{
    ...
    if(checkCase("Case 1: average()", r.average() , static_cast<double>(63.0 / 9.0)) )cnt++;
...
void TestCase2()
{
    ...
    if (checkCase("Case 2: average()", r.average(), static_cast<double>(35.0 / 5.0))) cnt++;
...
void TestCase3()
{
    ...
    if(checkCase("Case 3: average()", r.average() , static_cast<double>(82.5 / 6.0)) )cnt++;
...
void TestCase4()
{
    ...
    if(checkCase("Case 4: average()", r.average() , static_cast<double>(40.0 / 5.0)) )cnt++;
...
void TestCase5()
{
    ...
    if(checkCase("Case 5: average()", r.average() , static_cast<double>(87.5 / 7.0)) )cnt++;
